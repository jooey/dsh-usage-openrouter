...
create: () => openrouterUsageSnapshotResult$schema
},
...
/**
 * Official OpenRouter brand glyph, inlined from
 * https://openrouter.ai/brand/v2/openrouter-glyph-light.svg (2026-08 snapshot)
 * so the chip needs no network fetch. Brand fill follows the shell theme via
 * the body[data-ds-dark-theme] selector the DSW theme service sets: the
 * official purple (#7624F4) on light backgrounds, the official lime
 * (#C8FF00) on dark ones. Pass failed:true to color it with the danger
 * token instead (inline style beats the stylesheet rules).
 */
const OPENROUTER_GLYPH_PATH = "M303.9475,17.19926c42.79734,0,77.48933,34.69327,77.48933,77.48933s-34.69199,77.48933-77.48933,77.48933l76.86166,76.86244c9.76367,9.76313,2.84903,26.45667-10.95697,26.45667h-220.88335c-71.32686,0-129.14889-57.82202-129.14889-129.14889S77.64197,17.19926,148.96884,17.19926h154.97866ZM148.96884,68.85881c-42.79607,0-77.48933,34.69327-77.48933,77.48933s34.69327,77.48933,77.48933,77.48933,77.48933-34.69327,77.48933-77.48933-34.69327-77.48933-77.48933-77.48933Z";
const OPENROUTER_GLYPH_CLASS = "dsh-usage-openrouter-glyph";

function OpenRouterIcon(props) {
...
delete svgProps.failed;
const glyphProps = {
key: "glyph",
className: OPENROUTER_GLYPH_CLASS,
d: OPENROUTER_GLYPH_PATH
};
if (failed) {
glyphProps.style = { fill: "var(--dsw-alias-status-danger, #f25a5a)" };
}
return React.createElement("svg", svgProps, [
React.createElement("style", {
key: "theme-fill"
}, "." + OPENROUTER_GLYPH_CLASS + "{fill:#7624F4}body[data-ds-dark-theme] ." + OPENROUTER_GLYPH_CLASS + "{fill:#C8FF00}"),
React.createElement("path", glyphProps)
]);
}
...
const MARQUEE_STYLE_ID = "openrouter-usage-marquee-style";
...
style.textContent = [
"@keyframes openrouterUsageMarquee {",
"  0%, 10% { transform: translateX(0); }",
"  90%, 100% { transform: translateX(var(--marquee-shift, -100%)); }",
"}",
".openrouter-usage-marquee:hover .openrouter-usage-marquee-track {",
"  animation: openrouterUsageMarquee 9s linear infinite;",
"}"
].join("\n");
...
const clip = el.querySelector(".openrouter-usage-marquee-clip");
const track = el.querySelector(".openrouter-usage-marquee-track");
...
measure();
const el = chipRef.current;
const clip = el ? el.querySelector(".openrouter-usage-marquee-clip") : null;
...
className: "openrouter-usage-marquee",
style: {
display: "inline-flex",
alignItems: "center",
gap: "6px",
...
React.createElement(OpenRouterIcon, {
failed: failed
}),
React.createElement("span", {
key: "clip",
className: "openrouter-usage-marquee-clip",
style: {
...
React.createElement("span", {
  key: "track",
  className: "openrouter-usage-marquee-track",
  style: {
    display: "inline-flex",
    alignItems: "center",
    whiteSpace: "nowrap",
...
exports.OpenRouterIcon = OpenRouterIcon;
